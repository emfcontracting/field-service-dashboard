// app/api/verify-photos/debug/route.js
// Debug endpoint to see what's in emfcbre@gmail.com inbox
    ...
    imap.once('ready', () => {
      ...
      imap.openBox('INBOX', true, (err, box) => {
        ...
        fetch.once('end', () => {
          ...
          // Find photo emails
          results.photo_emails = emails.filter(e => 
            e.subject.toLowerCase().includes('photo') || 
            e.subject.toLowerCase().includes('foto')
          ).map(e => ({
            subject: e.subject,
            from: e.from,
            date: e.date
          ...
          // Search for specific WO if provided
          if (wo) {
