...
// (CIS/CA1/CA2/CIR/CMP). They are recorded as-is and never mapped onto
// cbre_status, which would mix the two worlds up.
// ─────────────────────────────────────────────────────────────────────────────
...
export const GRID_REFRESHABLE = ['open_both', 'billed_ours', 'closed_ours'];
