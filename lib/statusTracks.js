...
//              …with CIA hanging off it: an invoice rejected into audit because
//              the PMI paperwork was not in the Smartsheet first.
//
...
import { CBRE_POSTING_STATUS, CBRE_POSTING_ORDER, CBRE_POSTING_OFF_PATH } from './cbrePostingStatus';
...
export const TRACKS = {
  ...
  posting: {
    ...
    // CIA — invoice rejected into audit — is not progress, it is the invoice
    // standing still. It proves the invoice was submitted (CIS) and no more.
    offPath: CBRE_POSTING_OFF_PATH,
    ...
    read: (wo) => {
      ...
      return (CBRE_POSTING_ORDER.includes(code) || code in CBRE_POSTING_OFF_PATH) ? code : '';
    },
  },
};
